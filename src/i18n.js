...
export const STRINGS = {
  en: {
    ...
    hero: {
      ...
      sub: "A development duo crafting fast, secure and beautiful digital products — from landing pages to complex platforms.",
  ...
  ar: {
    ...
    hero: {
      ...
      sub: "ثنائي تطوير يصنع منتجات رقمية سريعة وآمنة وجميلة — من صفحات الهبوط إلى المنصات المعقدة.",
