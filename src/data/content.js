...
export const MEMBER_1 = {
  ...
  lastName: "Sherif",
  accent: "purple",
  role: { en: "Full Stack Developer", ar: "مطوّر فول ستاك" },
  roleColor: "#b88b91",
  image: "member1.jpg",
  bgText: "ABDELRHMAN",
  bio: {
    en: "Full stack developer and security engineer building fast, secure web platforms end-to-end.",
    ar: "مطوّر فول ستاك ومهندس أمان يبني منصات ويب سريعة وآمنة من البداية للنهاية.",
  },
  ...
  skills: [
    ...
    { label: { en: "Back End", ar: "خلفية" }, value: 88 },
    { label: { en: "Web Security", ar: "أمان الويب" }, value: 92 },
  ],
};
...
export const MEMBER_2 = {
  ...
  bgText: "SEIF",
  bio: {
    en: "Front-end focused full stack developer obsessed with pixel-perfect UI and smooth performance.",
    ar: "مطوّر فول ستاك تركيزه على الواجهات، مهووس بواجهات دقيقة وأداء سلس.",
  },
  ...
  skills: [
    { label: { en: "Front End", ar: "واجهات أمامية" }, value: 92 },
    { label: { en: "Back End", ar: "خلفية" }, value: 90 },
    { label: { en: "UI / Design", ar: "تصميم واجهات" }, value: 85 },
  ],
};
...
export const SERVICES = [
  {
    icon: "fa-code",
    title: { en: "Full Stack Development", ar: "تطوير فول ستاك" },
    desc: {
